...
const Developer = ({ animationName = 'idle', ...props }) => {
  ...
  const clips = [idleAnimation[0], saluteAnimation[0], clappingAnimation[0], victoryAnimation[0]].filter(Boolean);
  const { actions, mixer } = useAnimations(clips, group);

  // Stop mixer when component unmounts to avoid context issues
  useEffect(() => {
    return () => {
  ...
  useEffect(() => {
    if (!actions || !actions[animationName]) return undefined;
