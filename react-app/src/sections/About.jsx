...
const About = () => {
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText('pushkal.vashist@example.com');
    setHasCopied(true);
          ...
          <div className="grid-container" data-aos="fade-up" data-aos-delay="80">
            ...
            <div>
              ...
              <p className="grid-subtext">
                I am a student at Nanyang Polytechnic pursuing a Diploma in Applied AI & Analytics. I specialize in bridging the gap between AI research and field-ready systems.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="col-span-1 xl:row-span-4">
          <div className="grid-container" data-aos="fade-up" data-aos-delay="240">
            ...
            <div>
              ...
              <p className="grid-subtext">I&apos;m open to collaborations, internships, and hackathons worldwide.</p>
        ...
        <div className="xl:col-span-2 xl:row-span-3">
          <div className="grid-container" data-aos="fade-up" data-aos-delay="320">
            ...
            <div>
              ...
              <p className="grid-subtext">
                Connecting complex AI models to real operational workflows. I build systems that don&apos;t just &quot;work&quot; but solve critical problems at scale, from maritime logistics to civic engagement.
              </p>
            </div>
          </div>
        </div>
